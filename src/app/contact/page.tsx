      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">Phone & WhatsApp</h2>
            <a 
              href="https://wa.me/212631464929" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-xl text-gray-600 hover:text-gray-900 flex items-center gap-2"
            >
          ...
          <div className="bg-gray-50 p-6 rounded-lg">
            ...
            <a 
              href="https://maps.app.goo.gl/YaPEZWCZ2Yt2G5rc9" 
              target="_blank" 
              rel="noopener noreferrer"
              className="text-xl text-gray-600 hover:text-gray-900 flex items-center gap-2"
            >
